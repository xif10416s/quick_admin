...
public interface CommonConstant {
  ...
  /**访问权限认证未通过 401*/
  public static final Integer RESPONSE_CODE_401=401;

  /**访问授权未通过 403*/
  public static final Integer RESPONSE_CODE_403=403;
    ...
    */
    ...
    public static final Short HAS_SEND  = 1;
    public static final Short HAS_CANCLE  = 2;

    /**阅读状态（0未读，1已读）*/
    public static final Short HAS_READ_FLAG  = 1;
    public static final Short NO_READ_FLAG  = 0;
