...
import org.fxi.quick.common.util.ReflectUtil;
...
public class DictAspect {
    ...
    /**定义切点Pointcut */
    @Pointcut("execution(public * org.fxi.quick.module.*.controller.*Controller.*(..))")
        ...
        if (result instanceof Result) {
            if (((Result) result).getResult() instanceof IPage) {
                ...
                for (Object record : ((IPage) ((Result) result).getResult()).getRecords()) {
                    ...
                    JSONObject item = JSONUtil.parseObj(json,true);
                    for (Field field : ReflectUtil.getAllFields(record)) {
