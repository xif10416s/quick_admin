...
public interface SysUserMapper extends BaseMapper<SysUser> {
	 ...
	 * @return
	 */
	IPage<SysUser> getUserByDepId(Page page, @Param("departId") String departId,
...
//	List<SysUserDepVo> getDepNamesByUserIds(@Param("userIds") List<String> userIds);
	 ...
	 * @return
	 */
	IPage<SysUser> getUserByRoleId(Page page, @Param("roleId") Long roleId,
      @Param("username") String username);
...
//      @Param("userParams") SysUser userParams);
     ...
     * @return
     */
    Integer getUserByOrgCodeTotal(@Param("orgCode") String orgCode,
        @Param("userParams") SysUser userParams);
