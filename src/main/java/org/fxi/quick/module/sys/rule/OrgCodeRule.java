...
public class OrgCodeRule  {
    ...
    public Object execute(JSONObject params) {
        ...
        Long parentId = ParentIdUtils.EMPTY_ID;
...
//        }
        ...
        if (ParentIdUtils.isEmpty(parentId)) {
            // 线判断数据库中的表是否为空,空则直接返回初始编码
            query1.eq(SysDepart::getParentId, ParentIdUtils.EMPTY_ID).or().isNull(SysDepart::getParentId);
