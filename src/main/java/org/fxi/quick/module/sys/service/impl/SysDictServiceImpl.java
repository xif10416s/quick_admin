...
import org.fxi.quick.module.sys.mapper.SysDictMapper;
...
public class SysDictServiceImpl extends ServiceImpl<SysDictMapper, SysDict> implements
	...
	public List<DictModel> queryDictItemsByCode(String code) {
		...
		return this.getBaseMapper().queryDictItemsByCode(code);
	}

	@Override
	public Map<String, List<DictModel>> queryAllDictItems() {
		Map<String, List<DictModel>> res = new HashMap<String, List<DictModel>>();
		List<SysDict> ls = this.getBaseMapper().selectList(null);
	...
	public String queryDictTextByKey(String code, String key) {
		...
		return this.getBaseMapper().queryDictTextByKey(code, key);
	}
	...
	public List<DictModel> queryTableDictItemsByCode(String table, String text, String code) {
		...
		return this.getBaseMapper().queryTableDictItemsByCode(table,text,code);
	}

	@Override
	public List<DictModel> queryTableDictItemsByCodeAndFilter(String table, String text, String code, String filterSql) {
		log.info("无缓存dictTableList的时候调用这里！");
		return this.getBaseMapper().queryTableDictItemsByCodeAndFilter(table,text,code,filterSql);
	}
	...
	public String queryTableDictTextByKey(String table,String text,String code, String key) {
		...
		return this.getBaseMapper().queryTableDictTextByKey(table,text,code,key);
	}
	...
	public List<String> queryTableDictByKeys(String table, String text, String code, String[] keyArray) {
		List<DictModel> dicts = this.getBaseMapper().queryTableDictByKeys(table, text, code, keyArray);
    ...
    public Integer saveMain(SysDict sysDict, List<SysDictItem> sysDictItemList) {
		int insert=0;
    	try{
			 insert = this.getBaseMapper().insert(sysDict);
