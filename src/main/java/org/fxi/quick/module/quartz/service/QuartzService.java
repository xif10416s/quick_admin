...
public class QuartzService {
  ...
  public void addJob(Class<? extends QuartzJobBean> jobClass,
      String jobName, String jobGroupName, int jobTime,
    ...
    try {
      ...
      for (JobKey jobKey : jobKeys) {
        ...
        for (Trigger trigger : triggers) {
          putList(jobKey,trigger,jobList);
        }
      }
    } catch (SchedulerException e) {
      e.printStackTrace();
  ...
  private void putList (JobKey jobKey ,Trigger trigger, List<Map<String, Object>> jobList)
